        ...
        <div>
          <div className="bg-slate-800 border border-slate-400 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-sm  bg-opacity-30 relative">
            ...
            <div className="relative my-4 pt-2">
                ...
                <label htmlFor="" className="absolute text-m left-0 text-white duration-300 transform -translate-y-7 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-400 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0  peer-focus:scale-75 peer-focus:-translate-y-6 ">Name</label>
              </div>
              <div className="relative my-4 pt-2">
              ...
              <div>
                <span className="mt-4 text-white">Already Create an account? <Link to='/login' className=" m-1 text-blue-500 ">Login</Link></span>
              </div>
            </form>
          </div>
        </div>
